...
const products: SeedProduct[] = [
  ...
  {
    slug: "website-professional-business",
    name: "Professional Business Website",
    description:
      "A modern, professional business website built to look great and work properly across desktop, tablet, and mobile devices.",
    category: "CORE",
    basePrice: 149900,
    monthlySupport: 0,
    buildTimeDays: 5,
    features: [
      ...
      "Domain connection and SSL/security setup",
      "Deployment and launch",
      "30 days of post-launch support",
    ],
    tags: ["website-design", "new-website", "business-website", "lead-capture", "branding"],
    sortOrder: 24,
  },
  {
    slug: "website-ai-automation-package",
    name: "Website + AI Automation Package",
    description:
      "A professional business website combined with practical AI automation designed to help the business capture, respond to, and follow up with customers.",
    category: "CORE",
    basePrice: 299900,
    monthlySupport: 0,
    buildTimeDays: 10,
    features: [
      "Everything in the Professional Business Website package",
      "Custom AI chatbot configured around your business, answering questions 24/7",
      "Smart lead capture — name, phone, email, and service needs",
      "Appointment request/booking integration where supported, with routing and business notifications",
      "Automated initial follow-up and customer confirmation messages",
      "Follow-up workflow configured around your sales process",
      "Supported CRM/email integration where appropriate",
      "AI automation consultation to identify further time-saving opportunities",
    ],
    tags: ["website-design", "ai-chatbot", "lead-capture", "automation", "follow-up"],
    sortOrder: 25,
  },
  // ---- Modules ----
  {
